...
<liferay-ui:error exception="<%= DuplicateCategoryException.class %>" message="unable-to-move-category-because-one-with-the-same-name-already-exists-in-destination" />
